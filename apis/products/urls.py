...
from apis.products.views import ListCategoryAPIView, list_category, home, create_products, create_category, create_sub_category, detail_product, update_product, delete_product
...
urlpatterns = [
    ...
    path('detail_product/<int:id>/<str:slug>/delete/', delete_product, name='delete_product'),
